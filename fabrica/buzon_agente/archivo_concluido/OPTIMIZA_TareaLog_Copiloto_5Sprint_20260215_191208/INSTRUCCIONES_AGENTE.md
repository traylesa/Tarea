...
**Archivo principal:** OPTIMIZA TareaLog Copiloto_5Sprint.txt
...
**Acción:** Leer `OPTIMIZA TareaLog Copiloto_5Sprint.txt` y generar `00_ESTRATEGIA.md` con: objetivo claro, alcance (que SI y que NO), criterios de exito medibles, riesgos con mitigacion
...
**Acción:** Analizar `OPTIMIZA TareaLog Copiloto_5Sprint.txt` y generar `01_ANALISIS.md` con: Historias de Usuario (COMO/QUIERO/PARA), criterios de aceptacion (DADO/CUANDO/ENTONCES, minimo 3 por HU), requisitos no funcionales, dependencias
...
6. Al terminar TODAS las fases: `just concluir OPTIMIZA_TareaLog_Copiloto_5Sprint_20260215_191208`
