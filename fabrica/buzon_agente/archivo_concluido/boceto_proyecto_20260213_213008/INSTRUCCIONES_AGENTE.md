...
**Acción:** Leer `boceto_proyecto.md` y generar `00_ESTRATEGIA.md` con: objetivo claro, alcance (que SI y que NO), criterios de exito medibles, riesgos con mitigacion
...
**Acción:** Analizar `boceto_proyecto.md` y generar `01_ANALISIS.md` con: Historias de Usuario (COMO/QUIERO/PARA), criterios de aceptacion (DADO/CUANDO/ENTONCES, minimo 3 por HU), requisitos no funcionales, dependencias
...
6. Al terminar TODAS las fases: `just concluir boceto_proyecto_20260213_213008`
...
- [x] 08_OPERACION
- [x] 09_EVOLUCION
- [ ] Expediente concluido (pendiente: just concluir)
